...
<head>
    ...
    <!-- Title  -->
    <title>Mebellic | Shop - Lemari</title>
            ...
            <div class="widget catagory mb-50">
                ...
                <div class="catagories-menu">
                    <ul>
                        ...
                        <li class="active"><a href="shop3.php">Lemari</a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="row"><!-- Single Product Area -->
                    <?php
                        ...
                        $query = "SELECT * FROM produk INNER JOIN kategori ON kategori.id_kategori = produk.id_kategori WHERE kategori.kategori = 'lemari' ORDER by id_produk DESC LIMIT $num, $perpage";
