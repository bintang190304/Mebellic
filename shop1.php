...
<head>
    ...
    <!-- Title  -->
    <title>Mebellic | Shop - Chair &amp; Sofa</title>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <div class="shop_sidebar_area">
            ...
            <div class="widget catagory mb-50">
                ...
                <div class="catagories-menu">
                    <ul>
                        <li class="active"><a href="shop1.php">Chair &amp; Sofa</a></li>
                        <li><a href="shop2.php">Bed</a></li>
                        <li><a href="shop3.php">Lemari</a></li>
                        <li><a href="shop4.php">Accessories</a></li>
                    </ul>
                </div>
            </div>
        ...
        <div class="amado_product_area section-padding-100">
            ...
            <div class="row" id="bungkus">
                ...
                $query = "SELECT * FROM produk INNER JOIN kategori ON kategori.id_kategori = produk.id_kategori WHERE kategori.kategori = 'chairs' ORDER by id_produk DESC LIMIT $num, $perpage";
                $result = mysqli_query($koneksi, $query);
                while($row = mysqli_fetch_array($result)){
                    ?>

                    <!-- Single Product Area -->
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6" id="isi">
