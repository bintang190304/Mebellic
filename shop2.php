            ...
            <div class="widget catagory mb-50">
                ...
                <div class="catagories-menu">
                    <ul>
                        ...
                        <li class="active"><a href="shop2.php">Bed</a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <?php
                        ...
                        $query = "SELECT * FROM produk INNER JOIN kategori ON kategori.id_kategori = produk.id_kategori WHERE kategori.kategori = 'beds' ORDER by id_produk DESC LIMIT $num, $perpage";
